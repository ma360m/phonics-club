        ...
        <div className="rounded-lg border bg-card p-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Contact, address, and payment method can be edited during the 5-minute window.</p>
            </div>
          ...
          {editOpen && (
            <form action={updateAction} className="mt-5 space-y-4 border-t pt-5">
              ...
              <Button type="submit" disabled={updatePending || updateState.success} className="w-full rounded-lg bg-[#1D4ED8]">
