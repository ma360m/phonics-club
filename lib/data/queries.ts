...
import {
  ...
  applyChildrenPhonicsCourseDefaults,
  mergeMissingChildrenPhonicsCourses,
...
export async function getCourseBySlug(slug: string): Promise<Course | null> {
  ...
  return data
    ? normalizeCourse(applyChildrenPhonicsCourseDefaults(data as Course))
    : (fallback ? normalizeCourse(applyChildrenPhonicsCourseDefaults(fallback)) : null)
}
